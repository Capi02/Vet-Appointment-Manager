...
function eliminarCita(id) {
    ...
    transaction.onerror = () => {
        console.log('Ha ocurrido un errr para borrar la cita');
    }
...
function crearDB() {
    const crearDB = window.indexedDB.open('citas', 1) //Creando la base de datos version 1.0
    ...
    crearDB.onsuccess = function () {
        ...
        // Mostrar las citas al cargar  (Pero indexed DB ya esta listo)
        ui.imprimirCitas()
    }
